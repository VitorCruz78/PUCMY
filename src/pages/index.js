...
export default function Home() {
  ...
  const cardOptions = [
    ...
    { title: "Introdução", descriptions: "Programação é o processo de escrever instruções para que um computador execute uma tarefa específica. Essas instruções, chamadas de código, são escritas em...", picture: CardIntro}, 
    { title: "Estrutura em C", descriptions: "Criada em 1972 nos laboratórios Bell por Dennis Ritchie a linguagem C se tornou uma das mais bem-sucedidas linguagem de programação, sendo considerada de nível intermediário...", picture: CardEstrutura }, 
