...
export default function TimeToCode({ link }) {
    return (
        <>
            ...
            <div className="w-full h-fit md:h-80 rounded-lg shadow-lg bg-[#F4F4F4] mt-6">
                <div className="w-full h-full flex flex-col md:flex md:flex-row">
                    ...
                    />
                    <div className="w-full md:w-1/2 h-full p-6 flex flex-col items-start justify-between">
