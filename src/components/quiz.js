...
export default function Quiz(){
    return(
        <div className="w-full">
            ...
            <div className="flex flex-row items-start justify-start gap-12 w-[1140px] h-[540px] mt-10 rounded-xl shadow-xl">
                <Image 
                    className="h-full"
                    src={quizWoman}
                    width={500}
                ...
                <div className="mt-10 flex flex-col justify-center items-center gap-4 w-full">
                    <div>
                        <h1 className="text-4xl font-semibold">Hora do teste</h1>
                        <p className="text-xl font-semibold">Teste seu conhecimento sobre o que aprendeu!</p>
                    </div>
                    <div className="flex flex-col gap-8">
                        <div className="bg-gradient-to-r from-defaultOrange to-[#8D4C26]  w-[450px] h-12 flex flex-row justify-center items-center rounded-full">
                        ...
                        <div className="bg-gradient-to-r from-defaultTurq to-[#135258] w-[450px] h-12 flex flex-row justify-center items-center rounded-full">
                        ...
                        <div className="bg-gradient-to-r from-[#FF39B7] to-[#99226E] w-[450px] h-12 flex flex-row justify-center items-center rounded-full">
                        ...
                        <div className="bg-gradient-to-r from-[#00D66B] to-[#007138] w-[450px] h-12 flex flex-row justify-center items-center rounded-full">
                        ...
                        <div className="bg-gradient-to-r from-[#9B9ED1] to-[#444561] w-[450px] h-12 flex flex-row justify-center items-center rounded-full">
